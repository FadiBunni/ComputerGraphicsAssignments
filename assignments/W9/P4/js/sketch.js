...
function render(){
  ...
  /* SET VIEWMATRICES --------------------------------------------- */
    ...
    var obj_translate = translate(0, Math.sin(objTranslate) * 0.9 - 0.9, -3);
    ...
    // Prevent the reflection from being drawn when teapot is below the ground
    var clipplane = vec4(0,-1,0.265, 0); // Values are hardcoded!
    ...
    drawObj(objProgram, modelViewMatrixMirror, projectionMatrixMirror, false);
    gl.cullFace(gl.BACK);
